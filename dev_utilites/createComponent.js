/* eslint no-console: [0] */
const fs = require('fs');
const minimist = require('minimist'); /* eslint import/no-extraneous-dependencies: [0] */
...
// ${componentName}.propTypes = {}`;
    ...
    fs.mkdir(location, () => {
      ...
      fs.writeFile(`${location}/${componentName}.jsx`, component, () => {
        console.log(`${componentName}.jsx created`);
      });
      fs.writeFile(`${location}/${componentName}.css`, '', () => {
        console.log(`${componentName}.css created`);
      });
      fs.writeFile(`${location}/index.js`, index, () => {
