...
//   addProject() {
//     const title
//     const title = this.title.current.value.trim();
//     if (title) this.props.addProject(title);
//     return;
//   }
...
//         </ModalBody>
//         <ModalFooter>
//           <Button color="primary" onClick={() => this.addProject(this.title)}>
//             Submit new project
//           </Button>
...
//     addProject: title => {
//       const trimmedTitle = title.current.value.trim();
//       if (trimmedTitle) dispatch(addProject(title, authToken, history));
//       return;
//     },
//   };
// };
